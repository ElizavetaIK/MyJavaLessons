...
public class TaskArrayList {
    ...
    /*
     **Задание**: Создайте `ArrayList` для строк и добавьте в него следующие элементы:
     "Java", "Python", "C++".Выведите содержимое списка на экран.
     */
    ArrayList<String> languages = new ArrayList<>();
        ...
        /*
         **Задание**: Имея `ArrayList` с элементами "Red","Green", "Blue", "Yellow",
         * удалите "Green" и "Yellow" из списка.Выведите итоговый список на экран.
         */
        ...
        *  с элементами 4, 1, 3, 5, 2. Выведите на экран минимальный и максимальный элементы
         */
